...
<form method="GET" style="display:flex;gap:10px;margin-bottom:20px;flex-wrap:wrap;align-items:flex-end">
  ...
  <a href="/reussiteplus/questions.php" class="btn btn-ghost"><i data-lucide="x" style="width:13px;height:13px;vertical-align:-2px"></i> Reset</a>
  <?php endif; ?>
</form>

<div class="section-header">
  <div class="section-title"><i data-lucide="brain-circuit"></i> <?= number_format($total) ?> questions disponibles</div>
  <a href="/reussiteplus/examen.php" class="btn btn-primary btn-sm"><i data-lucide="pencil-line" style="width:13px;height:13px;vertical-align:-2px"></i> Passer un examen</a>
</div>
...
<div class="card" style="text-align:center;padding:48px">
  <div style="margin-bottom:16px;display:flex;justify-content:center"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--gris-300)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg></div>
