...
echo "Cible: 1000\n";
echo "À ajouter: " . max(0, 1000 - $current) . "\n\n";
...
/* ══ MATHÉMATIQUES (besoin ~8 pour atteindre 125) ══════════════ */
$m = 'maths';
$questions_maths = [
    ["Quelle est la limite de sin(x)/x quand x→0 ?", 'AVANCE', 'EXAMEN_ETAT', [['A','1',1],['B','0',0],['C','∞',0],['D','indéterminée',0]]],
...
/* ══ FRANÇAIS (besoin ~31 pour atteindre 125) ═════════════════ */
$prevAdded = $added;
$m = 'francais';
$questions_fr = [
    ...
    ["'Il a les dents du bonheur' est une expression qui signifie :", 'AVANCE', 'EXAMEN_ETAT', [['A','Avoir un écart entre les dents de devant',1],['B','Être toujours heureux',0],['C','Aimer sourire',0],['D','Avoir de belles dents',0]]],
    ...
    ["Que signifie l'expression 'avoir le cafard' ?", 'INTERMEDIAIRE', 'ENAFEP', [['A','Être triste, déprimé',1],['B','Avoir peur des insectes',0],['C','Être courageuse',0],['D','Avoir de la chance',0]]],
    ...
    ["Quel est le sens de 'épistémologie' ?", 'EXPERT', 'EXAMEN_ETAT', [['A','Étude critique des sciences et de la connaissance',1],['B','Étude des épidémies',0],['C','Étude de la lettre',0],['D','Science du sol',0]]],
];
...
$m = 'sciences';
$questions_sc = [
    ["Quelle est la formule de la photosynthèse (simplifiée) ?", 'INTERMEDIAIRE', 'TENASOSP', [['A','CO₂ + H₂O + lumière → glucose + O₂',1],['B','O₂ + glucose → CO₂ + H₂O',0],['C','H₂ + O₂ → H₂O',0],['D','N₂ + H₂ → NH₃',0]]],
    ["Quel est l'organe de l'olfaction (l'odorat) ?", 'DEBUTANT', 'ENAFEP', [['A','Le nez',1],['B','La langue',0],['C','L\'oreille',0],['D','L\'œil',0]]],
    ...
    ["Quel est l'organe qui filtre le sang dans l'organisme ?", 'ELEMENTAIRE', 'ENAFEP', [['A','Le rein',1],['B','Le foie',0],['C','Le cœur',0],['D','Le poumon',0]]],
    ...
    ["Quel sens utilise les récepteurs de la rétine ?", 'ELEMENTAIRE', 'ENAFEP', [['A','La vue',1],['B','L\'odorat',0],['C','Le toucher',0],['D','Le goût',0]]],
    ...
    ["Quel est l'organe central du système nerveux ?", 'DEBUTANT', 'ENAFEP', [['A','L\'encéphale (cerveau)',1],['B','La moelle épinière',0],['C','Le cœur',0],['D','La peau',0]]],
    ...
    ["Le nerf optique relie l'œil à :", 'ELEMENTAIRE', 'ENAFEP', [['A','Le cerveau',1],['B','Le tronc cérébral',0],['C','La moelle épinière',0],['D','L\'oreille',0]]],
...
/* ══ HISTOIRE-GÉO (besoin ~42 pour atteindre 125) ═══════════ */
$prevAdded = $added;
$m = 'histgeo';
$questions_hg = [
    ...
    ["Quel est le tropique qui passe par l'hémisphère nord ?", 'ELEMENTAIRE', 'TENASOSP', [['A','Tropique du Cancer',1],['B','Tropique du Capricorne',0],['C','Équateur',0],['D','Cercle arctique',0]]],
    ...
    ["La conférence de Berlin (1884-1885) a abouti à :", 'AVANCE', 'EXAMEN_ETAT', [['A','Le partage de l\'Afrique entre puissances européennes',1],['B','La fin de la traite négrière',0],['C','L\'indépendance de l\'Égypte',0],['D','La création de l\'Union africaine',0]]],
    ...
    ["Quelle organisation régionale regroupe les pays d'Afrique centrale ?", 'INTERMEDIAIRE', 'TENASOSP', [['A','CEEAC (Communauté Économique des États d\'Afrique Centrale)',1],['B','CEDEAO',0],['C','SADC',0],['D','UMA',0]]],
    ...
    ["Quel pays est à la fois en Afrique et en Asie ?", 'INTERMEDIAIRE', 'TENASOSP', [['A','Égypte',1],['B','Maroc',0],['C','Tunisie',0],['D','Libye',0]]],
    ...
    ["La RDC est traversée par l'Équateur, ce qui lui donne :", 'ELEMENTAIRE', 'ENAFEP', [['A','Un climat équatorial (chaud et humide)',1],['B','Un climat désertique',0],['C','Un climat tempéré',0],['D','Un climat polaire',0]]],
    ...
    ["En géographie, la 'latitude' mesure :", 'ELEMENTAIRE', 'ENAFEP', [['A','La distance angulaire par rapport à l\'Équateur',1],['B','La distance par rapport au méridien de Greenwich',0],['C','L\'altitude d\'un lieu',0],['D','La superficie d\'un pays',0]]],
    ["Quel est le rôle du Conseil de sécurité de l'ONU ?", 'AVANCE', 'EXAMEN_ETAT', [['A','Maintenir la paix et la sécurité internationales',1],['B','Gérer les finances mondiales',0],['C','Juger les chefs d\'État',0],['D','Distribuer l\'aide humanitaire',0]]],
    ["La guerre froide opposait principalement :", 'INTERMEDIAIRE', 'TENASOSP', [['A','Les États-Unis et l\'URSS',1],['B','L\'Allemagne et la France',0],['C','L\'Angleterre et l\'Espagne',0],['D','La Chine et le Japon',0]]],
...
echo "Histoire-Géo: +" . ($added-$prevAdded) . " questions\n";
...
$questions_ch = [
    ...
    ["La formule du dioxyde de carbone est :", 'DEBUTANT', 'ENAFEP', [['A','CO₂',1],['B','CO',0],['C','C₂O',0],['D','HCO₃',0]]],
    ...
    ["Quelle est la formule de l'acide sulfurique ?", 'INTERMEDIAIRE', 'TENASOSP', [['A','H₂SO₄',1],['B','HCl',0],['C','HNO₃',0],['D','H₂SO₃',0]]],
    ...
    ["Quel ion est responsable de l'acidité d'une solution ?", 'INTERMEDIAIRE', 'TENASOSP', [['A','H⁺ (ou H₃O⁺)',1],['B','OH⁻',0],['C','Na⁺',0],['D','Cl⁻',0]]],
    ["La formule de l'éthanol est :", 'INTERMEDIAIRE', 'TENASOSP', [['A','C₂H₅OH',1],['B','CH₃OH',0],['C','C₃H₇OH',0],['D','C₂H₄',0]]],
    ...
    ["Quelle réaction libère de l'énergie (exothermique) ?", 'AVANCE', 'EXAMEN_ETAT', [['A','La combustion',1],['B','L\'électrolyse',0],['C','La photosynthèse',0],['D','La dissolution de NH₄NO₃',0]]],
    ...
    ["Quel est le pH d'une solution basique ?", 'ELEMENTAIRE', 'ENAFEP', [['A','Supérieur à 7',1],['B','Inférieur à 7',0],['C','Égal à 7',0],['D','Variable',0]]],
    ...
    ["La rouille (oxyde de fer) a pour formule :", 'INTERMEDIAIRE', 'TENASOSP', [['A','Fe₂O₃',1],['B','FeO',0],['C','Fe₃O₄',0],['D','FeCl₂',0]]],
...
$questions_ph = [
    ...
    ["La chaleur se propage par conduction, convection et :", 'ELEMENTAIRE', 'ENAFEP', [['A','Rayonnement',1],['B','Évaporation',0],['C','Fusion',0],['D','Condensation',0]]],
    ...
    ["Qu'est-ce que l'effet photoélectrique ?", 'AVANCE', 'EXAMEN_ETAT', [['A','Émission d\'électrons par un métal éclairé',1],['B','Émission de photons',0],['C','Réflexion de la lumière',0],['D','Réfraction de la lumière',0]]],
    ...
    ["Un transformateur abaisseur a un rapport de transformation n = N₁/N₂ :", 'AVANCE', 'EXAMEN_ETAT', [['A','Supérieur à 1',1],['B','Inférieur à 1',0],['C','Égal à 1',0],['D','Négatif',0]]],
...
$questions_bio = [
    ...
    ["La respiration cellulaire aérobie utilise :", 'INTERMEDIAIRE', 'TENASOSP', [['A','O₂ et glucose',1],['B','CO₂ et eau uniquement',0],['C','Lumière et chlorophylle',0],['D','ATP uniquement',0]]],
    ...
    ["La fécondation est la fusion de :", 'ELEMENTAIRE', 'ENAFEP', [['A','Un gamète mâle et un gamète femelle',1],['B','Deux cellules somatiques',0],['C','Deux noyaux quelconques',0],['D','Deux cellules haploïdes identiques',0]]],
    ...
    ["Les virus se répliquent uniquement :", 'ELEMENTAIRE', 'ENAFEP', [['A','À l\'intérieur de cellules hôtes vivantes',1],['B','Dans un milieu liquide',0],['C','En dehors d\'un organisme',0],['D','Dans les laboratoires uniquement',0]]],
    ...
    ["Quelle hormone régule le cycle menstruel féminin ?", 'AVANCE', 'TENASOSP', [['A','LH et FSH (œstrogènes et progestérone)',1],['B','Testostérone uniquement',0],['C','Adrénaline',0],['D','Insuline',0]]],
