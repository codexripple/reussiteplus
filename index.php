...
<?php if (isset($_GET['alerte']) && $_GET['alerte'] === 'portail_enseignant'): ?>
<div style="background:#7F1D1D;color:#FCA5A5;text-align:center;padding:14px 24px;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:10px;flex-wrap:wrap">
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" style="flex-shrink:0"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
  <span><strong>Avertissement de sécurité :</strong> Vous avez tenté d'accéder à un espace interdit. Toute nouvelle tentative entraînera la <strong>suppression définitive de votre compte</strong>.</span>
  <a href="/reussiteplus/connexion.php" style="color:#FCD34D;font-weight:700;text-decoration:underline;white-space:nowrap">Connexion élève →</a>
</div>
<?php endif; ?>
