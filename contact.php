...
<nav class="nav">
  <a href="/reussiteplus/index.php" style="display:flex;align-items:center;gap:10px">
    ...
    <span style="font-family:var(--font-display);font-weight:800;color:white;font-size:16px">RÃ‰USSITE<span style="color:var(--primary-light)">+</span></span>
  </a>
  <div class="nav-links">
...
<div style="background:white;border-bottom:3px solid var(--primary);padding:28px 40px;text-align:center">
  <div style="max-width:700px;margin:0 auto">
    <p style="font-size:18px;color:var(--gris-800);line-height:1.7;font-style:italic">
      ðŸ’¡ <strong>En attendant notre rÃ©ponse</strong>, saviez-vous que les Ã©lÃ¨ves qui s'entraÃ®nent rÃ©guliÃ¨rement sur RÃ‰USSITE+ amÃ©liorent leurs rÃ©sultats de <strong style="color:var(--primary)">47% en moyenne</strong> avant les examens officiels ?
    </p>
  </div>
</div>
...
<div style="background:var(--gris-50);padding:72px 40px">
  <div style="max-width:1100px;margin:0 auto">
    ...
    <div style="background:linear-gradient(135deg,#0D1117,#1a3a2a);border-radius:20px;padding:36px;margin-bottom:48px;display:flex;gap:28px;align-items:center;flex-wrap:wrap;position:relative;overflow:hidden">
      ...
      <div style="width:72px;height:72px;border-radius:50%;background:linear-gradient(135deg,#007A5E,#00A97F);display:flex;align-items:center;justify-content:center;font-size:32px;flex-shrink:0">ðŸ‘©â€ðŸŽ“</div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px;margin-bottom:48px">
      ...
      <div style="background:white;border:2px solid var(--gris-200);border-radius:20px;padding:28px;position:relative">
        ...
        <ul style="list-style:none;margin-bottom:24px;font-size:13px;color:var(--gris-600);line-height:2">
          <li>âœ… 5 examens d'entraÃ®nement/mois</li>
          <li>âœ… Statistiques de base</li>
          <li>âŒ Archives officielles</li>
          <li>âŒ Examens illimitÃ©s</li>
        </ul>
      ...
      <div style="background:linear-gradient(160deg,#003d2b,#007A5E);border:2px solid var(--primary);border-radius:20px;padding:28px;position:relative;transform:scale(1.03);box-shadow:0 20px 60px rgba(0,122,94,.3)">
        <div style="position:absolute;top:-12px;left:50%;transform:translateX(-50%);background:var(--gold);color:white;font-size:10px;font-weight:800;padding:4px 14px;border-radius:50px;text-transform:uppercase;letter-spacing:1px;white-space:nowrap">â­ Le plus populaire</div>
        ...
        <ul style="list-style:none;margin-bottom:24px;font-size:13px;color:rgba(255,255,255,.8);line-height:2">
          <li>âœ… Examens illimitÃ©s</li>
          <li>âœ… Toutes les archives officielles</li>
          <li>âœ… Statistiques avancÃ©es</li>
          <li>âœ… RÃ©sultats dÃ©taillÃ©s</li>
        </ul>
      ...
      <div style="background:white;border:2px solid #7C3AED;border-radius:20px;padding:28px;position:relative">
        ...
        <ul style="list-style:none;margin-bottom:24px;font-size:13px;color:var(--gris-600);line-height:2">
          <li>âœ… Tout le plan Basique</li>
          <li>âœ… IA pÃ©dagogique personnalisÃ©e</li>
          <li>âœ… Coaching & suivi dÃ©taillÃ©</li>
          <li>âœ… Certificats de rÃ©ussite</li>
        </ul>
    ...
    <div style="background:white;border-radius:16px;padding:24px 28px;display:flex;align-items:center;gap:20px;flex-wrap:wrap;border:1px solid var(--gris-200)">
      <div style="font-size:14px;font-weight:700;color:var(--gris-700)">ðŸ’³ Paiement facile avec :</div>
      <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center">
        <div style="background:#FEF9EC;border:1px solid #F59E0B;border-radius:8px;padding:8px 16px;font-size:13px;font-weight:700;color:#92400E;display:flex;align-items:center;gap:6px">ðŸ“± M-Pesa</div>
        <div style="background:#FFF5EC;border:1px solid #F97316;border-radius:8px;padding:8px 16px;font-size:13px;font-weight:700;color:#9A3412;display:flex;align-items:center;gap:6px">ðŸ“± Orange Money</div>
        <div style="background:#EFF6FF;border:1px solid #3B82F6;border-radius:8px;padding:8px 16px;font-size:13px;font-weight:700;color:#1E40AF;display:flex;align-items:center;gap:6px">ðŸ“± Airtel Money</div>
      </div>
    ...
    <div style="text-align:center;margin-top:14px;font-size:12px;color:var(--gris-500)">âœ… Sans engagement Â· Annulable Ã  tout moment Â· 100% sÃ©curisÃ©</div>
...
<div class="hero-contact" style="position:relative;overflow:hidden">
  ...
  <div class="hero-contact-inner" style="position:relative">
    ...
    <div style="display:flex;justify-content:center;gap:24px;margin-top:32px;flex-wrap:wrap">
      <?php foreach (['âš¡ RÃ©ponse en < 24h','âœ… Support en franÃ§ais','ðŸ‡¨ðŸ‡© Ã‰quipe basÃ©e Ã  Kinshasa'] as $badge): ?>
  ...
  <div class="contact-grid">
    ...
    <div>
      ...
      <div style="margin-top:16px;border-radius:var(--radius-xl);overflow:hidden;position:relative;height:180px">
        <img src="https://images.unsplash.com/photo-1577896851231-70ef18881754?w=700&q=70" alt="Ã‰lÃ¨ves RÃ‰USSITE+" style="width:100%;height:100%;object-fit:cover">
    ...
    <div>
      ...
      <div style="margin-top:16px;background:linear-gradient(135deg,#0D1117,#1a2f50);border-radius:var(--radius-xl);padding:24px 28px;position:relative;overflow:hidden">
        ...
        <div style="position:relative">
          <div style="font-size:11px;font-weight:700;color:var(--gold);text-transform:uppercase;letter-spacing:1px;margin-bottom:8px">ðŸ’¡ Conseil de l'Ã©quipe</div>
...
<section class="cta-bottom" style="position:relative;overflow:hidden">
  ...
  <div class="cta-bottom-inner" style="position:relative">
    ...
    <div style="margin-top:14px;font-size:12px;color:rgba(255,255,255,.3)">âœ… Inscription en 30 secondes Â· Pas de carte bancaire</div>
  </div>
</section>
...
<footer class="footer">
  <div class="footer-inner">
    <div style="display:flex;align-items:center;gap:8px">
      ...
      <span style="font-family:var(--font-display);font-weight:800;color:rgba(255,255,255,.6);font-size:14px">RÃ‰USSITE+</span>
    </div>
